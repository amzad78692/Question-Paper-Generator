...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="faculty.php" class="brand-link">
      <img src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/000000/external-faculty-university-flaticons-flat-flat-icons-2.png" alt="Admin Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Welcome Faculty</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="faculty.php" class="d-block"><?php echo $_SESSION['fname'];?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="Insertquestion.php" class="nav-link active">
          ...
          <li class="nav-item menu-open">
            <a href="ViewAllQues.php" class="nav-link active">
