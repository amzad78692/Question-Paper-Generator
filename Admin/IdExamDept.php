...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- Content Header (Page header) -->
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Register Examination Department</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              ...
              <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="number" id="college-code-textbox" placeholder="College Code" name="ccode" required>
                  </div>
                  <div class="form-group">
                    <label for="college-name-textbox">College Name</label>
                    <input class="form-control" type="text" id="college-name-textbox" placeholder="College Name" name="cname" required>
                  </div>
                  <div class="form-group">
                    <label for="head-name-textbox">Exam Dept Head Name</label>
                    <input class="form-control" type="text" id="head-name-textbox" placeholder="Head Name" name="hname" required>
                  </div>
                  <div class="form-group">
                    <label for="email-textbox">Email</label>
                    <input class="form-control" type="text" id="email-textbox" placeholder="Email" name="email" required>
                  </div>
                  <div class="form-group">
